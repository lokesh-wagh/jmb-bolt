...
export const Mobile = (): JSX.Element => {
  // testimonials are rendered directly in the scroller; paging state removed
  // no auto-pagination on mobile
  const [isGalleryFaded] = useState(false);
  
  // Show all testimonials in the scroller
 const navigate = useNavigate();

  // Mobile layout: no auto-pagination required for testimonials scroller

  // testimonials rendered directly
  ...
  return (
    <div className="bg-white overflow-x-hidden w-full min-h-screen relative">
      ...
      <h2 id="virtual-invitation" className="relative mt-[7vh]  text-center [font-family:'Inria_Serif',Helvetica] font-bold text-black text-3xl md:text-4xl lg:text-5xl">
        Virtual Invitation
      </h2>
